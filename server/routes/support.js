...
const emailTexts = {
    tr: {
        admin: {
            ...
            autoGenerated: "Bu e-posta Monera uygulamasından otomatik olarak gönderilmiştir.",
            copyright: "© 2025 Monera - Tüm hakları saklıdır."
        },
        user: {
            subject: "✅ Sorun Raporunuz Başarıyla Alındı - Monera",
            reportReceived: "✅ Rapor Alındı!",
            thankYou: "Teşekkür ederiz",
            hello: "Merhaba!",
            successMessage: "Monera uygulamasına gönderdiğiniz sorun raporu başarıyla alınmıştır.",
    ...
    en: {
        admin: {
            ...
            copyright: "© 2025 Monera - All rights reserved."
        },
        user: {
            subject: "✅ Your Issue Report Successfully Received - Monera",
