...
const emailTexts = {
    tr: {
        admin: {
            subject: "🐛 [Monedsa] Yeni Sorun Bildirimi: ",
            ...
            urgentNote: "⚡ Bu sorun bildirimi acil olarak değerlendirilmeli ve kullanıcıya geri dönüş yapılmalıdır.",
            autoGenerated: "Bu e-posta Monedsa uygulamasından otomatik olarak gönderilmiştir.",
            copyright: "© 2025 Monedsa"
        },
        user: {
            subject: "✅ Sorun Raporunuz Başarıyla Alındı - Monedsa",
            reportReceived: "✅ Rapor Alındı!",
            thankYou: "Teşekkür ederiz",
            hello: "Merhaba!",
            successMessage: "Monedsa uygulamasına gönderdiğiniz sorun raporu başarıyla alınmıştır.",
            reportTitle: "📋 Rapor Başlığınız",
            reportDescription: "📋 Rapor Açıklamanız",
            nextSteps: "⏱️ Sonraki Adımlar:",
            step1: "Teknik ekibimiz sorunuzun detaylarını inceleyecek.",
            step2: "Gerekirse size ek bilgi almak için dönüş yapılacak.",
            step3: "Çözüm bulunduğunda bilgilendirileceksiniz.",
            step4: "Genellikle 24 saat içinde geri dönüş yapıyoruz.",
            tip: "💡 İpucu",
            tipText: "Bu e-postayı saklayın! Sorunuzla ilgili güncellemeler için bu e-posta adresini kullanabilirsiniz.",
            thanks: "Teşekkürler! 🙏",
            team: "Monedsa Geliştirici Ekibi",
            autoGenerated: "Bu e-posta Monedsa uygulamasından otomatik olarak gönderilmiştir.",
            contact: "Sorularınız için: support@vu4ll.com.tr",
            copyright: "© 2025 Monedsa"
        }
    },
    en: {
        admin: {
            subject: "🐛 [Monedsa] New Issue Report: ",
            ...
            urgentNote: "⚡ This issue report should be evaluated urgently and a response should be made to the user.",
            autoGenerated: "This email was automatically sent from the Monedsa application.",
            copyright: "© 2025 Monedsa"
        },
        user: {
            subject: "✅ Your Issue Report Successfully Received - Monedsa",
            reportReceived: "✅ Report Received!",
            thankYou: "Thank you",
            hello: "Hello!",
            successMessage: "Your issue report sent to the Monedsa application has been successfully received.",
            reportTitle: "📋 Your Report Title",
            reportDescription: "📋 Your Report Description",
    ...
    nl: {
        admin: {
            subject: "🐛 [Monedsa] Nieuwe probleemmelding: ",
            newIssue: "🛠️ Nieuwe probleemmelding",
            appName: "Monedsa",
            ...
            urgentNote: "⚡ Dit probleem moet als urgent worden beschouwd en de gebruiker moet worden teruggebeld.",
            autoGenerated: "Deze e-mail is automatisch verzonden vanuit de Monedsa-app.",
            copyright: "© 2025 Monedsa - Alle rechten voorbehouden."
        },
        user: {
            subject: "✅ Uw probleemrapport is succesvol ontvangen - Monedsa",
            reportReceived: "✅ Rapport ontvangen!",
            thankYou: "Bedankt",
            hello: "Hallo!",
            successMessage: "Het probleemrapport dat u naar de Monedsa-app hebt gestuurd, is succesvol ontvangen.",
            reportTitle: "📋 Titel van uw melding",
            reportDescription: "📋 Beschrijving van uw melding",
            nextSteps: "⏱️ Volgende stappen:",
            step1: "Ons technische team zal de details van uw vraag onderzoeken.",
            step2: "Indien nodig nemen we contact met u op voor aanvullende informatie.",
            step3: "U wordt op de hoogte gebracht zodra er een oplossing is gevonden.",
            step4: "Meestal nemen we binnen 24 uur contact met u op.",
            tip: "💡 Tip",
            tipText: "Bewaar deze e-mail! U kunt dit e-mailadres gebruiken voor updates over uw vraag.",
            thanks: "Bedankt! 🙏",
            team: "Monedsa-ontwikkelaarsteam",
            autoGenerated: "Deze e-mail is automatisch verzonden vanuit de Monedsa-app.",
            contact: "Voor vragen: support@vu4ll.com.tr",
            copyright: "© 2025 Monedsa"
        }
    },
};
